...
async def forwards():
    ...
    manager.add_table(
        class_name="Firm", tablename="firm", schema=None, columns=None
    )
    ...
    manager.add_column(
        table_class_name="Firm",
        tablename="firm",
        column_name="firm_image",
        db_column_name="firm_image",
    ...
    manager.add_column(
        table_class_name="Firm",
        tablename="firm",
        column_name="firm_latitude",
        db_column_name="firm_latitude",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        table_class_name="Firm",
        tablename="firm",
        column_name="firm_longitude",
        db_column_name="firm_longitude",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        table_class_name="Firm",
        tablename="firm",
        column_name="firm_type",
        db_column_name="firm_type",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        table_class_name="Attendance",
        tablename="attendance",
        column_name="check_in_latitude",
        db_column_name="check_in_latitude",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        table_class_name="Attendance",
        tablename="attendance",
        column_name="check_in_longitude",
        db_column_name="check_in_longitude",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        table_class_name="Attendance",
        tablename="attendance",
        column_name="check_in_address",
        db_column_name="check_in_address",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
