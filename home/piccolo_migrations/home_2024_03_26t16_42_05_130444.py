...
async def forwards():
    ...
    manager.add_column(
        table_class_name="Device",
        tablename="device",
        column_name="device_build_number",
        db_column_name="device_build_number",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
    ...
    manager.add_column(
        ...
        db_column_name="device_finger_print",
        column_class_name="Varchar",
        column_class=Varchar,
        params={
            "length": 255,
